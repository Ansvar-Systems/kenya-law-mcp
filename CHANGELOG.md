...
## [1.0.0] - 2026-XX-XX
### Added
- Initial release of Kenya Law MCP
- `search_legislation` tool for full-text search across all Kenyan statutes
...
[Unreleased]: https://github.com/Ansvar-Systems/kenya-law-mcp/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/Ansvar-Systems/kenya-law-mcp/releases/tag/v1.0.0
